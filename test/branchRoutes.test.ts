...
//   return {
//     __esModule: true,
//     createBranch: jest.fn((_req, res, _next) => res.status(201).json({ message: 'mocked create' })),
//     getAllBranches: jest.fn((_req, res, _next) => res.status(200).json({ message: 'mocked getAll' })),
//     getBranchById: jest.fn((_req, res, _next) => res.status(200).json({ message: 'mocked getById' })),
//     updateBranch: jest.fn((_req, res, _next) => res.status(200).json({ message: 'mocked update' })),
//     deleteBranch: jest.fn((_req, res, _next) => res.status(204).json({ message: 'mocked delete' })),
//   };
// });
